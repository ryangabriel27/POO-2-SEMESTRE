    ...
    public static void main(String[] args) {
        ...
        while (menu) {
            ...
            int acao = Integer.parseInt(
                    JOptionPane.showInputDialog("O que você deseja fazer?" + "\n 1: Cadastro do Animal"
            ...
            if (acao == 1) {
                ...
                if (especieAnimal == 1) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "O número do paciente é :" + cachorro[contCachorro].getnPaciente(),
                            "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "O número do paciente é :" + gato[contGato].getnPaciente(),
                            "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                    contGato++;
                    ...
                    aves[contAves].setIdade(Integer.parseInt(JOptionPane.showInputDialog("Digite a idade do animal:")));
                    aves[contAves].setPorte(JOptionPane.showInputDialog("Digite o porte do animal:"));
                    aves[contAves]
                            .setProprietario(JOptionPane.showInputDialog("Digite o nome do proprietário do animal:"));
                    aves[contAves].setnPaciente(300 + contAves);
                    JOptionPane.showMessageDialog(null, "O número do paciente é :" + aves[contAves].getnPaciente(),
                            "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                    contAves++;
                    ...
                    JOptionPane.showMessageDialog(null, "O número do paciente é :" + outros[contOutro].getnPaciente(),
                            "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                    contOutro++;
                } else {
                ...
                while (agenda) {
                    ...
                    agendaClientes[contClientes].setNomeCliente(JOptionPane.showInputDialog("Qual é o seu nome?"));
                    agendaClientes[contClientes].setDataDesejada(
                            JOptionPane.showInputDialog("Em que dia você deseja fazer a consulta? (DD/MM)"));
                    agendaClientes[contClientes].setHorarioDesejado(
                            JOptionPane.showInputDialog("Em qual horário você deseja fazer a consulta? (HH:MM)"));


                    for (int j = 0; j < contClientes; j++) {
                        if (agendaClientes[contClientes].getAgendamento() == agendaClientes[j].getAgendamento()) {
                            JOptionPane.showMessageDialog(null,
                                    "O horário que você deseja está ocupado! Escolha outro!", "Erro!",
                                    JOptionPane.ERROR_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(null, "Horário agendado, aguardamos sua presença :)",
