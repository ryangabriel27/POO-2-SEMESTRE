...
public class Exercicio3CardLayout extends JFrame {
    ...
    public Exercicio3CardLayout() {
        ...
        JPanel camposLogin = new JPanel(new GridLayout(2, 2, 1, 1));
        ...
        login.add(fazerLogin, BorderLayout.SOUTH);
        ...
        JButton fazerCadastro = new JButton("Cadastrar");
        cadastro.add(fazerCadastro, BorderLayout.SOUTH);
        ...
        fazerLogin.addActionListener(e -> {
